...
const Folder = (t0) => {
  ...
  return /* @__PURE__ */ jsxs("li", { className: t3, children: [
    /* @__PURE__ */ jsxs(ComponentToUse, { ...isLink ? {
      href: item.route,
      prefetch: false
    } : {
      "data-href": item.route
    }, className: t6, onClick: handleClick2, onFocus, children: [
      t7,
      t10
    ] }),
...
const File = (t0) => {
  ...
  if ($[9] !== href || $[10] !== item.title || $[11] !== onFocus || $[12] !== t4) {
    t5 = /* @__PURE__ */ jsx(Anchor, { href, className: t4, onFocus, prefetch: false, children: item.title });
    $[9] = href;
    $[10] = item.title;
    $[11] = onFocus;
    $[12] = t4;
  ...
  if ($[14] !== active || $[15] !== activeSlug || $[16] !== anchors) {
    t6 = active && anchors.length > 0 && /* @__PURE__ */ jsx("ul", { className: cn(classes.list, classes.border), children: anchors.map((t72) => {
      const {
        id,
        value
      } = t72;
  ...
  if ($[18] !== t2 || $[19] !== t5 || $[20] !== t6) {
    t7 = /* @__PURE__ */ jsxs("li", { className: t2, children: [
      t5,
      t6
    ] });
    $[18] = t2;
...
const Sidebar = () => {
  ...
  let t6;
  if ($[8] !== t4 || $[9] !== t5) {
    t6 = cn("nextra-sidebar x:print:hidden", "x:transition-all x:ease-in-out", "x:max-md:hidden x:flex x:flex-col", "x:h-[calc(100dvh-var(--nextra-navbar-height))]", "x:top-(--nextra-navbar-height) x:shrink-0", t4, t5);
    $[8] = t4;
    $[9] = t5;
    $[10] = t6;
  } else {
...
function _temp4(t0) {
  ...
  return cn("x:rounded-md x:p-2", hover ? "x:bg-gray-200 x:text-gray-900 x:dark:bg-primary-100/5 x:dark:text-gray-50" : "x:text-gray-600 x:dark:text-gray-400");
}
