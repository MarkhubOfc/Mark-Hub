...
EN.MouseButton1Click:Connect(function()
  loadstring(game:HttpGet('https://raw.githubusercontent.com/Zynkore/Hub/refs/heads/main/Games/SNK%3ARumbling/EN.luau'))()
  s:Destroy()
end)

local PT_BR = new('TextButton', {
  Name = 'Portugues lang ( Not available )',
  Size = UDim2.new(0, 75, 0, 45),
  BackgroundColor3 = Color3.fromHex('#2e2e2e'),
  Text = 'Português ( Não disponível )',
  TextColor3 = Color3.fromHex('#cfcfcf'),
  TextScaled = true,
  Parent = LangLi
})
